...
public class MainDeleteEmployee {
    ...
    private static final String requestOrder = "DELETE_EMPLOYEE";
    private static final Deque<ClientRequest> clientRequests = new ArrayDeque<ClientRequest>();
        public static  void DeleteEmployee (Students students) throws Exception {
            ...
            for(final Student guy : students.getStudents()) {
                ...
                final DeleteEmployeesClientRequest clientRequest = new DeleteEmployeesClientRequest(
                        networkConfig,
