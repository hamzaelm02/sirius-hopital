...
public class SelectProfession {
    ...
    private static final String requestOrder = "SELECT_ALL_PROFESSIONS";
    private static final Deque<ClientRequest> clientRequests = new ArrayDeque<ClientRequest>();


    public static Professions getProfession () throws Exception {
        ...
        final SelectProfessionClientRequest clientRequest = new SelectProfessionClientRequest(
                networkConfig,
        ...
        final Professions professions = (Professions) joinedClientRequest.getResult();
